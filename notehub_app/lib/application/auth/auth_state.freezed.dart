...
class _$AuthStateCopyWithImpl<$Res, $Val extends AuthState>
  ...
  @override
  $Res call({Object? isShowLoading = null}) {
    return _then(
      _value.copyWith(
            isShowLoading:
                null == isShowLoading
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl({this.isShowLoading = false});
  ...
  @override
  String toString() {
    return 'AuthState(isShowLoading: $isShowLoading)';
  }
...
abstract class _AuthState implements AuthState {
  const factory _AuthState({final bool isShowLoading}) = _$AuthStateImpl;
